package hicham.apps.repository;

import hicham.apps.JhipsterAppsApp;
import hicham.apps.config.Constants;
import hicham.apps.config.audit.AuditEventConverter;
import hicham.apps.domain.PersistentAuditEvent;
...
import static hicham.apps.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
