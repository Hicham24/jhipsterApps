package hicham.apps.web.rest;
import hicham.apps.config.Constants;

import hicham.apps.JhipsterAppsApp;
import hicham.apps.domain.Authority;
import hicham.apps.domain.User;
import hicham.apps.repository.AuthorityRepository;
import hicham.apps.repository.UserRepository;
import hicham.apps.security.AuthoritiesConstants;
import hicham.apps.service.MailService;
import hicham.apps.service.UserService;
import hicham.apps.service.dto.UserDTO;
import hicham.apps.web.rest.vm.KeyAndPasswordVM;
import hicham.apps.web.rest.vm.ManagedUserVM;
